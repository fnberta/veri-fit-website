...
export enum FileFieldsEnum {
  ...
  ChildMarkdownRemarkFrontmatterPrices = 'childMarkdownRemark___frontmatter___prices',
  ChildMarkdownRemarkFrontmatterPricesPrice = 'childMarkdownRemark___frontmatter___prices___price',
  ChildMarkdownRemarkFrontmatterPricesType = 'childMarkdownRemark___frontmatter___prices___type',
  ChildMarkdownRemarkFrontmatterPricesValidity = 'childMarkdownRemark___frontmatter___prices___validity',
...
export enum MarkdownRemarkFieldsEnum {
  ...
  FrontmatterPricesValidity = 'frontmatter___prices___validity',
...
export type MarkdownRemarkFrontmatter = {
  ...
  image?: Maybe<File>;
  prices?: Maybe<Array<Maybe<MarkdownRemarkFrontmatterPrices>>>;
...
export type MarkdownRemarkFrontmatterFilterInput = {
  ...
  prices?: Maybe<MarkdownRemarkFrontmatterPricesFilterListInput>;
...
export type MarkdownRemarkFrontmatterPrices = {
  __typename?: 'MarkdownRemarkFrontmatterPrices';
  price?: Maybe<Scalars['Int']>;
  type?: Maybe<Scalars['Int']>;
  validity?: Maybe<Scalars['String']>;
};

export type MarkdownRemarkFrontmatterPricesFilterInput = {
  price?: Maybe<IntQueryOperatorInput>;
  type?: Maybe<IntQueryOperatorInput>;
  validity?: Maybe<StringQueryOperatorInput>;
};

export type MarkdownRemarkFrontmatterPricesFilterListInput = {
  elemMatch?: Maybe<MarkdownRemarkFrontmatterPricesFilterInput>;
};
...
export type IndexPageQuery = { __typename?: 'Query' } & {
  logo: Maybe<{ __typename?: 'File' } & FluidImageNoBase64Fragment>;
                  ...
                  Array<
                    Maybe<
                      { __typename?: 'MarkdownRemarkFrontmatterPrices' } & Pick<
                        MarkdownRemarkFrontmatterPrices,
                        'price' | 'type' | 'validity'
                      >
                    >
                  >
...
export type ManagePageQueryVariables = {};

export type ManagePageQuery = { __typename?: 'Query' } & {
  schedule: { __typename?: 'MarkdownRemarkConnection' } & {
    nodes: Array<
      { __typename?: 'MarkdownRemark' } & {
        frontmatter: Maybe<
